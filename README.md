...
EEG cleaning and extraction of spectral features and posterior dominant rhythm were computed in Python. Downsteam analyses including machine learning models and statistical analyses were computed in R.
...
10. [FSA](https://cran.r-project.org/web/packages/FSA/index.html)
11. [ggpubr](https://cran.r-project.org/web/packages/ggpubr/index.html)
12. [mgcv](https://cran.r-project.org/web/packages/mgcv/index.html)
